...
CREATE TABLE sly_article (id INTEGER NOT NULL, clang INTEGER NOT NULL, revision INTEGER DEFAULT 0 NOT NULL, tip BOOLEAN DEFAULT '0' NOT NULL, online BOOLEAN DEFAULT '0' NOT NULL, deleted BOOLEAN DEFAULT '0' NOT NULL, type VARCHAR(64) NOT NULL, re_id INTEGER NOT NULL, path VARCHAR(255) NOT NULL, pos INTEGER NOT NULL, name VARCHAR(255) NOT NULL, catpos INTEGER NOT NULL, catname VARCHAR(255) NOT NULL, startpage BOOLEAN DEFAULT '0' NOT NULL, createdate DATETIME NOT NULL, updatedate DATETIME NOT NULL, createuser VARCHAR(128) NOT NULL, updateuser VARCHAR(128) NOT NULL, attributes CLOB NOT NULL, PRIMARY KEY(id, clang, revision));
CREATE INDEX parents ON sly_article (re_id);
CREATE INDEX types ON sly_article (type);
CREATE TABLE sly_article_slice (id INTEGER NOT NULL, article_id INTEGER NOT NULL, clang INTEGER NOT NULL, revision INTEGER DEFAULT 0 NOT NULL, pos INTEGER NOT NULL, slot VARCHAR(64) NOT NULL, slice_id INTEGER NOT NULL, createdate DATETIME NOT NULL, updatedate DATETIME NOT NULL, createuser VARCHAR(128) NOT NULL, updateuser VARCHAR(128) NOT NULL, PRIMARY KEY(id));
