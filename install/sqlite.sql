...
CREATE TABLE sly_article (id INTEGER NOT NULL, clang INTEGER NOT NULL, revision INTEGER DEFAULT 0 NOT NULL, re_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, catname VARCHAR(255) NOT NULL, catpos INTEGER NOT NULL, attributes TEXT NOT NULL, startpage BOOLEAN NOT NULL, pos INTEGER NOT NULL, path VARCHAR(255) NOT NULL, status INTEGER NOT NULL, type VARCHAR(64) NOT NULL, deleted BOOLEAN NOT NULL, createdate DATETIME NOT NULL, updatedate DATETIME NOT NULL, createuser VARCHAR(255) NOT NULL, updateuser VARCHAR(255) NOT NULL, PRIMARY KEY(id, clang, revision));
