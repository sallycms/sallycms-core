...
CREATE TABLE sly_article_slice (id SERIAL NOT NULL, clang INT NOT NULL, slot VARCHAR(64) NOT NULL, pos INT NOT NULL, slice_id INT DEFAULT 0 NOT NULL, article_id INT NOT NULL, createdate INT NOT NULL, updatedate INT NOT NULL, createuser VARCHAR(255) NOT NULL, updateuser VARCHAR(255) NOT NULL, revision INT DEFAULT 0 NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE sly_user (id SERIAL NOT NULL, name VARCHAR(255) NULL, description VARCHAR(255) NULL, login VARCHAR(50) NOT NULL, password CHAR(40), status BOOLEAN NOT NULL, rights TEXT NOT NULL, lasttrydate INT DEFAULT 0 NOT NULL, timezone VARCHAR(64) NULL, createdate INT NOT NULL, updatedate INT NOT NULL, createuser VARCHAR(255) NOT NULL, updateuser VARCHAR(255) NOT NULL, revision INT DEFAULT 0 NOT NULL, PRIMARY KEY(id));
