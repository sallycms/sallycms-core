...
CREATE TABLE sly_file (id SERIAL NOT NULL, revision INT DEFAULT 0 NOT NULL, category_id INT NOT NULL, title VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, originalname VARCHAR(255) NOT NULL, filetype VARCHAR(255) NOT NULL, filesize INT NOT NULL, width INT NOT NULL, height INT NOT NULL, createdate TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updatedate TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, createuser TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updateuser TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, attributes TEXT DEFAULT NULL, PRIMARY KEY(id));
